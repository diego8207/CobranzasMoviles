...
public class SuspensionesRestantesActivity extends AppCompatActivity {
    ...
    public void inicializarListaSuspensiones(){
        ...
        suspensiones.add(new Suspension("356680", "70506190", "9001700", "COMFENALCO TOLIMA", "12 - Ibagué 12", "1 - IBAGUE", "MZ 7 CS 4 COMFENALCO ET 1", "1/15/17", "11 - SUSPENSION", "Susver BT Bornera", "SE DEJA AL USUARIO SUSPENDIDO SELLO INSTALADO PSY110800 LECTURA 8661"));
        suspensiones.add(new Suspension("243916", "70506190", "9001700", "Murillo Hermiro", "12 - Ibagué 12", "1 - IBAGUE", "MZ 6 CS 20 COMFENALCO ET 3", "1/15/17", "11 - SUSPENSION", "Susver BT Bornera", "SE DEJA AL USUARIO SUSPENDIDO SELLO INSTALADO PSY110800 LECTURA 8661"));
        suspensiones.add(new Suspension("58235", "70506190", "9001700", "Ducuara Fonseca Ana Rosmira", "12 - Ibagué 12", "1 - IBAGUE", "MZ D CS 5 URBANIZACION SANTA RITA ETAPA 3 DIAGONAL 6 SUR ", "1/15/17", "11 - SUSPENSION", "Susver BT Bornera", "SE DEJA AL USUARIO SUSPENDIDO SELLO INSTALADO PSY110800 LECTURA 8661"));
    ...
    public void inicializarAdaptador(){
        SuspensionAdaptador adaptador = new SuspensionAdaptador(suspensiones);
